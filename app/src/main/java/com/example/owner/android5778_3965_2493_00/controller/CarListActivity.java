...
public class CarListActivity extends Activity {
    ...
    void initItemByListView() {
       final List<Car> myList = DBManagerFactory.getManager().getCars();
        ...
        ArrayAdapter<ClipData.Item> adapter = new ArrayAdapter<ClipData.Item>(this, R.layout.row_car, myList) {
            @Override
            public View getView(int position, View convertView, ViewGroup parent) {
                if (convertView == null)
                {
                    convertView = View.inflate(CarActivity.this, R.layout.row_car, null);
                }
